...
export const UrlBannersApi = 'banners';
export const UrlProductsApi = 'products';
...
export const ErrorRetrievingData = 'Error while retrieving data: ';
...
export const ErrorCodeRetrievingData = 'efd';
